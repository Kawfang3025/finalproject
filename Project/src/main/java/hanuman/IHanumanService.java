...
public interface IHanumanService {
    ...
    public abstract void updateStatusHead(String repairingID);
    public abstract void updateStatusTech(String repairingID);
    public abstract void updateDateRP(String repairingID,String dateRP);
    public abstract void updateDateTechnicainRP(String repairingID,String technicainID);
}